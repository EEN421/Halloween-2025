...
# -*- coding: utf-8 -*-
"""
Icy Blue Dragon Eye — Fissure Pupil (Pi Zero W + GC9A01 240x240 SPI)
- Glacial iris with crystalline striations + speckles
- Jagged 'ice fissure' pupil (serrated slit w/ subtle zigzag centerline)
...
IRIS_OUTER           = (22, 92, 132)    # deep ice
IRIS_MID             = (40, 150, 200)   # bright cyan
IRIS_INNER           = (210, 240, 255)  # frosty white-blue
...
class IcyDragonEye:
    def __init__(self, w=240, h=240):
        ...
        # Fissure pupil params (icy variant)
        self.slit_height = 136
        self.base_width  = 16
        self.pointiness  = 2.1
        self.serration_amp  = 0.24   # a touch cleaner than magma
        self.serration_freq = 0.33
        self.center_zigzag  = 1.0
    ...
    def _draw_fissure_pupil(self, d, ix, iy):
    ...
    def draw(self):
        ...
        self._draw_fissure_pupil(d, ix, iy)
...
# -------- Main --------
def main():
    print("❄️ Icy Blue Dragon Eye — Fissure — Pi Zero W + GC9A01")
    lcd = GC9A01(); lcd.init(); eye = IcyDragonEye(240,240)
